...
<link
	href="2025-11-28-ZAP-Report-2/normalize/normalize.css" rel="stylesheet">
<link
	href="2025-11-28-ZAP-Report-2/themes/original/main.css" rel="stylesheet">
<link
	href="2025-11-28-ZAP-Report-2/themes/original/colors.css" rel="stylesheet">
</head>
<body>
	<header>
		...
		<p>
			<span>Generated with</span> <a href="https://zaproxy.org"><img
				src="2025-11-28-ZAP-Report-2/zap32x32.png" alt="The ZAP logo" class="zap-logo">ZAP</a>
			<span>on Fri 28 Nov 2025, at 17:37:34</span>
		</p>
				...
				<table class="risk-confidence-counts-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><span>1</span><br> <span
								class="additional-info-percentages">(16.7%)</span></td>
							<td><span>4</span><br> <span class="additional-info-percentages">(66.7%)</span></td>
						</tr>
						<tr>
							...
							<td><span>0</span><br> <span
								class="additional-info-percentages">(0.0%)</span></td>
							<td><span>1</span><br> <span class="additional-info-percentages">(16.7%)</span></td>
						</tr>
						<tr>
			...
			<section
				...
				<table class="alert-type-counts-table">
					...
					<tbody>
						...
						<tr>
							<th scope="row"><a
								href="#alert-type-2">Format String Error</a></th>
							<td class="risk-level">Medium</td>
							<td><span>1</span><br> <span
								class="additional-info-percentages">(16.7%)</span></td>
						</tr>
						...
						<tr>
							...
							<td><span>12</span><br> <span
								class="additional-info-percentages">(200.0%)</span></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
							...
							<ol>
								...
								<li>
									...
									<ol>
										<li><details>
												<summary>
													<span class="request-method-n-url">GET http://localhost:8000/</span>
												</summary>
...
<p>Content Security Policy (CSP) is an added layer of security that helps to detect and mitigate certain types of attacks, including Cross Site Scripting (XSS) and data injection attacks. These attacks are used for everything from data theft to site defacement or distribution of malware. CSP provides a set of standard HTTP headers that allow website owners to declare approved sources of content that browsers should be allowed to load on that page — covered types are JavaScript, CSS, HTML frames, fonts, images and embeddable objects such as Java applets, ActiveX, audio and video files.</p>
	...
	<tr>
		...
		<td><details open="open">
				<summary>Request line and header section (270 bytes)</summary>
				
				<pre><code>GET http://localhost:8000/ HTTP/1.1
host: localhost:8000
...
content-length: 3341
date: Fri, 28 Nov 2025 15:10:40 GMT
						...
						<li class="alerts--site-li">
							...
							<ol>
								...
								<li>
									<h5>
										<a
											href="#alert-type-2">Format String Error</a> <span>(1)</span>
									</h5>
									<ol>
										<li><details>
												<summary>
	...
	<tr>
		...
		<td>
			<ul class="alert-tags-list">
				...
				<li>
					<span><a href="https://cwe.mitre.org/data/definitions/134.html">CWE-134</a></span> 
				</li>
			</ul>
		</td>
	</tr>
...
<p>Potential Format String Error. The script closed the connection on a /%s.</p>
	...
	<tr>
		<th scope="row">Request</th>
		<td><details open="open">
				<summary>Request line and header section (349 bytes)</summary>
...
content-length: 228
				...
				<summary>Request body (228 bytes)</summary>
				
				<pre><code>username=ZAP%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%25n%25s%0A&amp;password=ZAP&amp;birthdate=2025-11-28&amp;role=administrator</code></pre>
...
vary: Accept-Encoding
content-length: 25
date: Fri, 28 Nov 2025 15:10:52 GMT
	...
	<tr>
		...
		<td><pre><code>ZAP%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s%n%s
</code></pre></td>
	</tr>
							...
							<ol>
								...
								<li>
									...
									<ol>
										<li><details>
												<summary>
													<span class="request-method-n-url">GET http://localhost:8000/static/index.js</span>
												</summary>
...
<p>At &quot;High&quot; threshold this scan rule will not alert on client or server error responses.</p>
	...
	<tr>
		...
		<td><details open="open">
				...
				<pre><code>GET http://localhost:8000/static/index.js HTTP/1.1
host: localhost:8000
user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36
pragma: no-cache
cache-control: no-cache
						...
						<li class="alerts--site-li">
							...
							<ol>
								...
								<li>
									<h5>
										<a
											href="#alert-type-5">User Agent Fuzzer</a> <span>(1)</span>
									</h5>
									<ol>
										<li><details>
												<summary>
...
content-length: 83
				...
				<pre><code>username=foo-bar%40example.com&amp;password=ZAP&amp;birthdate=2025-11-28&amp;role=administrator</code></pre>
...
vary: Accept-Encoding
content-length: 25
date: Fri, 28 Nov 2025 15:10:53 GMT
						...
						<table class="alert-types-table">
							<tr>
								...
								<td>
									   ...
									   <span>raised by an active scanner</span> <span>(<a
										href="https://www.zaproxy.org/docs/alerts/30002/">Format String Error</a>)
									</span>   
								</td>
							</tr>
							<tr>
								<th scope="row">CWE ID</th>
								<td><a
									href="https://cwe.mitre.org/data/definitions/134.html">134</a></td>
							</tr>
							<tr>
								<th scope="row">WASC ID</th>
								<td>6</td>
							...
							<tr>
								...
								<td>
									<ol>
										<li><a
											href="https://owasp.org/www-community/attacks/Format_string_attack">https://owasp.org/www-community/attacks/Format_string_attack</a></li>
									</ol>
								</td>
							</tr>
						</table>
